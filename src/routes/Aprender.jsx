...
const Aprender = () => {
  ...
  return (
    <div>
      <div className=" md:flex justify-around bg-[#D45769] w-auto overflow-hidden relative block z-20 ">
        <img
      ...
      <div className="bg-white md:w-full drop-shadow-sm md:flex flex  md:justify-between top-0 sticky overflow-scroll h-full  md:h-full">
        <div>
          <button
            onClick={() => scrollTo(problem)}
            className=" md:text-lg text-xs md:p-8 p-4 hover:text-[#D45769]"
            style={{
        ...
        <div>
          <button
            ...
            className=" text-xs md:text-lg md:p-8 p-4 hover:text-[#D45769]"
            style={{
              backgroundColor: "white",
              border: "none",
              outline: "none",
        ...
        <div>
          ...
          >
            <div className="">High-Fidelity </div> <div>Mockups</div>
      ...
      <div ref={problem} className="">
        <div ref={problemRef} className="my-10 md:my-32  ">
          <div className=" lg:mx-44 md:mx-12 mx-8 text-left">
            ...
            <p className="sm:text-sm md:text-xl lg:text-xl leading-relaxed">
              I grew up in a very diverse zip code in Seattle. I was surrounded
              by languages and people from all over the world. One day, I
              decided to purchase something at a corner shop near where I lived.
              Feeling confident, I decided to practice my Spanish with some of
              the employees at that shop. But when I got there, I couldn’t
              recall any Spanish words or phrases related to the context I was
              in. Which led me to wonder...
            </p>
          </div>
        ...
        <div ref={researchRef} className="my-10 md:my-32 ">
          <div ref={research} className="  lg:mx-44 md:mx-12 mx-8 text-left ">
            ...
            <div className="grid gird-cols-1 justify-center mb-20">
              <div className="bg-slate-200 p-5 md:p-20 md:mb-24 mb-10 md:flex">
                <div className="justify-between">
                  <img
                    className=""
                    width={300}
                    height={300}
                    src={"survey-seven.svg"}
                    alt="corner shop"
                  ></img>
                  <img
                    className=""
        ...
        <div ref={designRef} className=" grid grid-cols-1 md:my-32 my-10">
          <div ref={design} className=" lg:mx-44 md:mx-12 mx-8  text-left">
            <p className="font-semibold md:text-five mb-4 text-2xl">
              Design Solutions
            </p>
            <div className="flex justify-evenly">
        ...
        >
          <div className=" ">
            <p
              ref={wireframing}
              className="font-semibold md:text-five mb-4 text-2xl "
            >
              Wireframing
            </p>
            <div className="flex justify-evenly">
        ...
        >
          <p
            ref={testing}
            className="font-semibold text-five mb-4 text-xl md:text-five "
          >
            Usability Testing
          </p>
          <div className="flex justify-evenly">
            <p className="sm:text-sm md:text-xl lg:text-xl leading-relaxed">
              ...
              asked a couple of people to test initial designs of the app using
              the systems usability scale, InVision as a prototyping tool. They
              tested the sketches in places where they were most likely to use
              the app with their personal phones. With their feedback I was able
              to make quick design changes to the sketches before I designed the
              high-fidelity mockups. Because of this the final mockups differed
              little from the original sketches, which saved me a lot of time.
            </p>
          </div>
        ...
        <div ref={mockupsRef} className=" md:my-32 my-10  text-left  ">
          <p
            ref={mockups}
            className="font-semibold  lg:mx-44 md:mx-12  mb-4 mx-8 text-xl md:text-five  "
          >
            The Corner Shop{" "}
              ...
              <div>
                <div className="lg:flex md:flex">
                  <div className=" font-Bhaijaan2 lg:text-2xl lg:m-auto lg:p-24 md:m-auto md:p-3 m-10  text-left">
                    Sarah lives in the Rainier Vallely, one of the most diverse
                    zip codes in the United States. There is a new corner shop
                    that has opened up a few blocks away from where she lives.
                    Sarah wants to try out her Spanish in a way to better
                    connect with her new neighbors. Before she departs Sarah
                    opens up the app Aprender.
                  </div>

                  <video className="m-auto" width="250" muted autoPlay loop>
                    <source src="aprender-video-1.mov" type="video/mp4" />
                  </video>
                </div>
                ...
                <div className="md:flex lg:flex">
                  ...
                  <video className="m-auto" width="250" muted autoPlay loop>
                    <source src="aprender-video-2.mov" type="video/mp4" />
                  </video>
                ...
                <div className="md:flex lg:flex">
                  ...
                  <video className="m-auto" width="250" muted autoPlay loop>
                    <source src="aprender-video-3.mov" type="video/mp4" />
                  </video>
                </div>
        ...
        >
          <p
            ref={nextSteps}
            className="font-semibold md:text-five mb-6 text-xl "
          >
